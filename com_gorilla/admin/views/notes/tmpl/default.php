...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_gorilla&task=notes.saveOrderAjax&tmpl=component';
...
<script type="text/javascript">
	...
	{
		table = note.getElementById("sortTable");
		direction = note.getElementById("directionTable");
...
<form
	action="<?php echo JRoute::_('index.php?option=com_gorilla&view=notes'); ?>"
	...
	<?php endif;?>
		<div id="filter-bar" class="btn-toolbar">
			...
			<div class="btn-group pull-left">
				...
				<button class="btn hasTooltip" type="button" title="<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>" onclick="note.id('filter_search').value='';this.form.submit();">
			...
			<tbody>
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
					...
					<td class="nowrap has-context">
						<!-- <a class="btn btn-micro active hasTooltip" title="" onclick="return listItemTask('cb0','notes.unpublish')" href="javascript:void(0);" data-original-title="">
						    <i class="icon-download"></i>
						</a> -->
						<a href="<?php echo JRoute::_('index.php?option=com_gorilla&task=note.edit&id='.(int) $item->id); ?>">
