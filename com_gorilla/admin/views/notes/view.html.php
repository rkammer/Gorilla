...
/**
 * Methods display a list of notes records.
 *
 * @package		Joomla.Administrator
 * @subpackage	com_gorilla
 */
class GorillaViewNotes extends JViewLegacy {
	...
	public function display($tpl = null) {
		...
		// add submenu in view
		GorillaHelper::addSubmenu('notes');
	...
	protected function addToolbar() {
		...
		if (version_compare(JVERSION, '3', 'lt')) {
			...
			JHtmlSidebar::setAction('index.php?option=com_gorilla&view=notes');
