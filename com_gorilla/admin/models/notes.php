...
/**
 * Methods supporting a list of notes records.
 *
 * @package		Joomla.Administrator
 * @subpackage	com_gorilla
 */
class GorillaModelNotes extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				...
				'a.publish_up, a.publish_down, a.asset_id '
			)
		);
