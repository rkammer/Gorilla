...
<div class="container-fluid">
	...
	<div class="row">
	    <div class="span12">
	        <h2 class="notebook-title"><?php echo JText::_('COM_GORILLA_NOTEBOOKS_TITLE'); ?></h2>
	    </div>
	</div>
	...
	<div class="row-fluid">
		...
		<div class="<?php echo $span ?>">
			...
			<?php if ($this->params->get('show_description') == 1) : ?><p class="muted notebookj25-p-muted"><?php echo $col->description; ?></p><?php endif; ?>
	    </div>    
	    <?php endforeach; ?>
	    <?php //if (count($row) == 1) : ?>
